...
public class  Factura{
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("%-30s%-30s%-30s        %30s\n","08759 Burgos,Burgos","47300 Cadiz,Cadiz", Utils.TEXTNEGRITA+"VENCIMIENTO "+Utils.RESETASCII, "29-01-2019");

        System.out.println("─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────");
        System.out.printf("%-30s                                                                                            %.2f\n",Utils.TEXTNEGRITA+"Total"+Utils.RESETASCII, 199.95);
        System.out.println("─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────");
        
        System.out.printf("%-30s%-30s%30s%30s \n", Utils.TEXTNEGRITA+"CANT.", "    DESCRIPCIÓN","                            PRECIO","                       IMPORTE"+Utils.RESETASCII);
        System.out.println(Utils.TEXTNEGRITA+"                                                                                   UNITARIO"+Utils.RESETASCII);
